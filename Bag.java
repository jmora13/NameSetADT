// File: Bag.java from the package edu.colorado.collections
// Additional javadoc documentation is available from the Bag link in:
//   http://www.cs.colorado.edu/~main/docs



/******************************************************************************
* An Bag is a collection of int numbers.
...
*
* @see
*   <A HREF="../../../../edu/colorado/collections/Bag.java">
*   Java Source Code for this class
*   (www.cs.colorado.edu/~main/edu/colorado/collections/Bag.java)
*   </A>
*
* @author Michael Main 
...
public class  Bag implements Cloneable
{
   ...
   **/   
   public static Bag union(Bag b1, Bag b2)
   {
      ...
      // Integer.MAX_VALUE, there will be an arithmetic overflow and
      // the bag will fail.   
      Bag answer = new Bag(b1.getCapacity( ) + b2.getCapacity( ));
